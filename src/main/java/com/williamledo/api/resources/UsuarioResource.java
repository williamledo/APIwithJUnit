...
public class UsuarioResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<UsuarioDTO> findById(@PathVariable Integer id){//quando tem variavel de path, tenho que informar @Pathvariable
	...
	@PostMapping
	public ResponseEntity<UsuarioDTO> create(@RequestBody UsuarioDTO obj) { //Para dizer que o obj vai chegar em JSON quando for fazer a requisição e vai ser desserializado para um objeto User
		// como vou enviar algo, no caso os novos dados a serem atualizados, coloco o @RequestBody
	...
	public ResponseEntity<UsuarioDTO> update(@PathVariable Integer id, @RequestBody UsuarioDTO obj) {
		//quando tem variavel de path, tenho que informar @PathVariable
		// como vou enviar algo, no caso os novos dados a serem atualizados, coloco o @RequestBody
		obj.setId(id);
